...
public abstract class DefaultAdapter<T> extends RecyclerView.Adapter<BaseHolder<T>> {
    ...
    public void addHeadView(RecyclerView recyclerView,View mHeaderView){
        HeaderAndFooterRecyclerViewAdapter headerAdapter=new HeaderAndFooterRecyclerViewAdapter(this);
        RecyclerViewUtils.addHeaderView(recyclerView,mHeaderView);
    }
    /**
     * 创建Hodler
     *
