package middlem.person.app;//package person.middlem.viewmodule;
...
//    private WindowManager.LayoutParams wmParams = ((App)getContext().getApplicationContext()).getMywmParams();
  static WindowManager.LayoutParams mLayoutParams = App.getMywmParams();
    ...
    public void show() {
        if (isDismiss&&null==mViewImpl) {
            ...
            childView = mViewImpl.findViewById(R.id.iv);
        }
